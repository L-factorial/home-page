...
class DiffusionConfig{
    constructor(canvas, ctx){
        ...
        this.velocityX = [2, 2, -2, 2, -2];
        this.velocityY = [-2, -3, 3, 2, -2.5];
    ...
    init() {
        ...
        for(let l = 0; l < blockingBalls; ++l) {
            let topBall =  new Particle(blockBallX, blockBallYTop, 0, 0, blockBallRadius*1000, blockBallRadius, l, 'white', false); 
            let bottomBall =  new Particle(blockBallX, blockBallYBottom, 0, 0, blockBallRadius*1000, blockBallRadius, l+blockingBalls, 'white', false); 
